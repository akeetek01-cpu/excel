    ...
    $.ajax(settings)
      .done(function (response) {
        if (
          ...
          $("#passwordWrapper").removeClass("disabled_input-wrapper");
          ...
          $("#passwordWrapper").addClass("disabled_input-wrapper");
          ...
          // Update account info
          $("#accountStatusText").html(
            "Account is not active.<br>" +
            "Password field is disabled.<br>" +
            "Activate Account button is shown."
          );
          $("#accountInfo").show();
        }
